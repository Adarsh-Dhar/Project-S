...
// [Previous code remains unchanged until tests section]
...
mod tests {
    ...
    fn test_lend() {
        ...
        let mut lender_lamports = 2000000;
    ...
    fn test_repay() {
        ...
        // Setup borrower's tracking account with existing borrowed amount
        ...
        let mut repayer_lamports = 2000000;
